          ...
          <div className="acc-sheet__pane acc-wiz__pane--wide">
            ...
            {mode === null && (
              <div className="acc-wiz__chooser">
                <button type="button" className="acc-wiz__choice" onClick={() => setMode('paste')}>
                ...
                >
                  ...
                  <span className="acc-wiz__choice-body">
                    Common wordings in six categories, ready to tick. A quick start when the plan is
                    not in front of you.
                  </span>
                </button>
              </div>
            ...
            {mode !== null && (
              <div className="acc-wiz__back">
                <button type="button" className="acc-wiz__backlink" onClick={() => setMode(null)}>
